...
class WeatherActivity : AppCompatActivity() {
    ...
    val viewModel by lazy { ViewModelProvider(this,
        ViewModelProvider.AndroidViewModelFactory.getInstance(application)).get(WeatherViewModel::class.java)}
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel.weatherLiveData.observe(this, Observer { result ->
            ...
            if (weather!=null){
                ...
                Toast.makeText(this,result.toString()/*"无法成功获取天气信息"*/,Toast.LENGTH_SHORT).show()
